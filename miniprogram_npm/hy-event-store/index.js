...
__DEFINE__(1641256279036, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1641256279037,"./event-store":1641256279038}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641256279037, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1641256279038, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1641256279037,"./utils":1641256279039}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641256279039, function(require, module, exports) {
...
return __REQUIRE__(1641256279036);
})()
